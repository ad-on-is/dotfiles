...
map("n", "<leader>fh", function()
  vim.cmd("DiffviewFileHistory % --no-merges --show-pulls")
...
map("n", "|", function()
  vim.cmd("vsplit | wincmd h | bprevious | wincmd l")
end)
map("n", "&", function()
  vim.cmd("split | wincmd k | bprevious | wincmd j")
end)
map("n", "dmö", function()
